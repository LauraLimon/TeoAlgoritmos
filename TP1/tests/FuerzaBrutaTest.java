...
public class FuerzaBrutaTest extends TestCase {
    ...
    public void testEncontrarElemento() {
        ...
        int i = 0;
        for (int k : ks) {
            Comparable resultadoOrdenado = FuerzaBruta.EncontrarElemento(ordenado, k);
        ...
        i = 0;
        for (int k : ksGrande) {
            Integer resultadoAleatorio1 = (Integer) FuerzaBruta.EncontrarElemento(aleatorioGrande1, k);
            assertEquals(resultadosKGrande[i], resultadoAleatorio1);
            Integer resultadoAleatorio2 = (Integer) FuerzaBruta.EncontrarElemento(aleatorioGrande2, k);
            assertEquals(resultadosKGrande[i], resultadoAleatorio2);
            Integer resultadoAleatorio3 = (Integer) FuerzaBruta.EncontrarElemento(aleatorioGrande3, k);
            assertEquals(resultadosKGrande[i], resultadoAleatorio3);
            Integer resultadoAleatorio4 = (Integer) FuerzaBruta.EncontrarElemento(aleatorioGrande4, k);
