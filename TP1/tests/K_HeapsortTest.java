 ...
 * @author chicas
 */
public class K_HeapsortTest extends TestCase {
    ...
    public K_HeapsortTest(String testName) {
        super(testName);
    ...
    /**
     * Test of sort method, of class K_Heapsort.
     */
    public void testSort() {
        ...
        int i = 0;
        for (int k : ks) {
            Comparable resultadoOrdenado = K_Heapsort.EncontrarElemento(ordenado, k);
            assertEquals(resultadosK[i], resultadoOrdenado);
            Integer resultadoOrdenadoInv = (Integer) K_Heapsort.EncontrarElemento(ordenadoInversa, k);
            assertEquals(resultadosK[i], resultadoOrdenadoInv);
            Integer resultadoAleatorio = (Integer) K_Heapsort.EncontrarElemento(aleatorioChico, k);
        ...
        i = 0;
        for (int k : ksGrande) {
            Integer resultadoAleatorio1 = (Integer) K_Heapsort.EncontrarElemento(aleatorioGrande1, k);
            assertEquals(resultadosKGrande[i], resultadoAleatorio1);
            Integer resultadoAleatorio2 = (Integer) K_Heapsort.EncontrarElemento(aleatorioGrande2, k);
            assertEquals(resultadosKGrande[i], resultadoAleatorio2);
            Integer resultadoAleatorio3 = (Integer) K_Heapsort.EncontrarElemento(aleatorioGrande3, k);
            assertEquals(resultadosKGrande[i], resultadoAleatorio3);
            Integer resultadoAleatorio4 = (Integer) K_Heapsort.EncontrarElemento(aleatorioGrande4, k);
