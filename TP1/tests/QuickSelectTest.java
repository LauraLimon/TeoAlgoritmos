...
public class QuickSelectTest extends TestCase {
    ...
    public void testEncontrarElemento() {
        ...
        i = 0;
        for (int k : ksGrande) {
            Integer resultadoAleatorio1 = (Integer) QuickSelect.EncontrarElemento(aleatorioGrande1, k);
            assertEquals(resultadosKGrande[i], resultadoAleatorio1);
            Integer resultadoAleatorio2 = (Integer) QuickSelect.EncontrarElemento(aleatorioGrande2, k);
            assertEquals(resultadosKGrande[i], resultadoAleatorio2);
            Integer resultadoAleatorio3 = (Integer) QuickSelect.EncontrarElemento(aleatorioGrande3, k);
            assertEquals(resultadosKGrande[i], resultadoAleatorio3);
            Integer resultadoAleatorio4 = (Integer) QuickSelect.EncontrarElemento(aleatorioGrande4, k);
